...
export function Sidebar({ isCollapsed = false, onToggleCollapse }: SidebarProps) {
  ...
  useEffect(() => {
    ...
    try {
      const stored = localStorage.getItem("blockd-tutorial-state");
      if (stored) {
        ...
        if (parsed.isActive) {
          setTutorialContext({
            ...
            nextStep: () => {
              ...
              localStorage.setItem("blockd-tutorial-state", JSON.stringify(updated));
  ...
  return (
    <aside
      className={clsx(
        "h-screen bg-card/50 backdrop-blur-sm border-r border-border/50 flex flex-col shrink-0 transition-[width] duration-150 ease-out",
    ...
    >
      ...
      <div className="relative flex w-full items-center p-2 pt-2">
        ...
        >
          ...
          >
            ...
            />
            <span className="text-sm font-semibold text-foreground">blockd</span>
          </Link>
        </div>
            ...
            >
              <div className="flex items-center justify-center text-foreground">
                <div className="flex items-center justify-center rounded-full transition-all ease-in-out group-hover:-rotate-3 group-hover:scale-110 group-active:rotate-6 group-active:scale-[0.98]">
                  <div className="flex items-center justify-center rounded-full size-[1.4rem] -mx-[0.2rem] bg-muted-foreground/15 group-hover:bg-muted-foreground/25">
      ...
      {/* Footer - User Profile */}
      <div className="flex items-center gap-2 transition border-t-[0.5px] border-border/50">
