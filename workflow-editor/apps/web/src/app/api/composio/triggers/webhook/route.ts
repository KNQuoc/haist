...
export async function POST(request: NextRequest) {
  try {
    ...
    // Note: User verification is handled by the auth layer.
    // With Convex, we trust the userId from the webhook payload.
    // TODO: Add user verification via Convex if needed.
